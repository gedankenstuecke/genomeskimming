...
printf "echo \"art_illumina -i Clagr_pseudogenome.fasta -p -l 250 -f ";
printf "%.6f", coverage;
print " -m", $1, "-s 0 -o", $1, "-1 EmpMiSeq250R1.txt -2 EmpMiSeq250R2.txt\" | qsub -V -S /bin/bash -cwd -j y -N clagr" $1, "-r y -q all.q ";
