...
IN1=../clad8_ast2-F.fastq
IN2=../clad8_ast2-R.fastq

# Parameters
SGA_BIN=~/bin/sga/src/SGA/sga
...
$SGA_BIN preprocess --pe-mode 1 -o sga-preprocessed.fastq $IN1 $IN2
...
$SGA_BIN index -a ropebwt -t $CPU --no-reverse sga-preprocessed.fastq

# Perform error correction with a 41-mer.
# The k-mer cutoff parameter is learned automatically
$SGA_BIN correct -k $CK --discard --learn -t $CPU -o reads.ec.k$CK.fastq sga-preprocessed.fastq
...
/home/bastian/Downloads/sga/src/bin/sga-align --name sga.pe $CTGS $IN1 $IN2

# Make contig-contig distance estimates
/home/bastian/Downloads/sga/src/bin/sga-bam2de.pl -n $MIN_PAIRS --prefix libPE sga.pe.bam

# Make contig copy number estimates
/home/bastian/Downloads/sga/src/bin/sga-astat.py -m $MIN_LENGTH sga.pe.refsort.bam > libPE.astat
